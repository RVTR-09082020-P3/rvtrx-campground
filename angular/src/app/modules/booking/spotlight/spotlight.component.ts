...
export class SpotlightComponent implements OnChanges {
  ...
  ngOnChanges(): void {
    ...
    //Dummy data
    //this.imageUrl = "https://play-lh.googleusercontent.com/niSCOgqAwJyjNwyRbu1QvsBw0CM1DQg8ypE3_cbMWSnsI-0saVU3HDfPsbtYlT9ie4Q=w200-h300-rw";

    
  }

  setSpotlight(lodgings: any[] | null): void {
    let temp = 0;
      ...
      for (const lodging of lodgings) {
        if (lodging.rentals.length > temp) {
          ...
          if(this.selectedLodging)
          {
            ...
            this.selectedLodging.imageUrls[0] = "https://play-lh.googleusercontent.com/niSCOgqAwJyjNwyRbu1QvsBw0CM1DQg8ypE3_cbMWSnsI-0saVU3HDfPsbtYlT9ie4Q=w200-h300-rw"
